...
import com.example.model.MathBranch
import com.example.model.MathFormula
import com.example.model.MathGrade
import com.example.model.MathHandbookRepository
import com.example.model.MathTopic
import java.util.Locale

@OptIn(ExperimentalLayoutApi::class)
@Composable
fun MathHandbookSection(
    modifier: Modifier = Modifier
) {
    val context = LocalContext.current
    var searchQuery by remember { mutableStateOf("") }
    var selectedGrade by remember { mutableStateOf<MathGrade?>(null) }
    var selectedBranch by remember { mutableStateOf<MathBranch?>(null) }
    ...
    val filteredTopics = remember(searchQuery, selectedGrade, selectedBranch, showOnlyBookmarked, bookmarkedTopicIds.size) {
        MathHandbookRepository.allTopics.filter { topic ->
            ...
            val matchesQuery = query.isEmpty() ||
                ...
                topic.importantIdentitiesAndTheorems.any { it.lowercase(Locale.ROOT).contains(query) } ||
                ...
                Column(
                    ...
                    Row(
                        ...
                        Row(
                            ...
                            Column {
                                Text(
                                    text = "Mathematics Compendium",
                                    style = MaterialTheme.typography.titleLarge,
                                    fontWeight = FontWeight.Bold,
                                    color = MaterialTheme.colorScheme.onTertiaryContainer
                                )
                                Text(
                                    text = "All Formulas, Identities & Theorems: Class 6 to Class 12",
                        ...
                        Surface(
                            ...
                            Text(
                                text = "${filteredTopics.size} Chapters",
                                style = MaterialTheme.typography.labelMedium,
                                fontWeight = FontWeight.Bold,
                                color = MaterialTheme.colorScheme.tertiary,
                    ...
                    Text(
                        text = "Curated syllabus repository featuring algebraic identities, geometric theorems, trigonometric expansions, calculus formulas, matrices, coordinate geometry, vectors, and live variable calculators.",
            ...
            Card(
                ...
                Column(
                    ...
                    OutlinedTextField(
                        ...
                        modifier = Modifier
                            .fillMaxWidth()
                            .testTag("math_search_input"),
                        placeholder = {
                            Text("Search identity, theorem, formula (e.g. Pythagoras, Binomial, Bayes, Heron)...", fontSize = 13.sp)
                        },
                        leadingIcon = {
                    ...
                    Row(
                        ...
                        MathGrade.values().forEach { grade ->
                            FilterChip(
                    ...
                    // Math Branch Filter (Algebra, Geometry, Trigonometry, etc.)
                    Row(
                        modifier = Modifier
                            .fillMaxWidth()
                            .horizontalScroll(rememberScrollState()),
                        ...
                        MathBranch.values().forEach { branch ->
                            FilterChip(
            ...
            item {
                Card(
                    ...
                    Column(
                        ...
                        Text(
                            text = "No matching math topics found",
                            style = MaterialTheme.typography.titleMedium,
                            fontWeight = FontWeight.SemiBold,
                            color = MaterialTheme.colorScheme.onSurface
                        )
                        Text(
                            text = "Try adjusting your search keywords, class level, or mathematical branch.",
                            style = MaterialTheme.typography.bodySmall,
    ...
    Card(
        ...
        Column(
            ...
            if (topic.keyFormulas.isNotEmpty()) {
                Column(verticalArrangement = Arrangement.spacedBy(8.dp)) {
                    Row(
                        ...
                        Text(
                            text = "Key Formulas & Algebraic/Trig Identities",
                    ...
                    topic.keyFormulas.forEach { formula ->
                        MathFormulaCard(formula = formula)
                    }
                }
            }

            // Expandable Detailed Concept, Theorems & Applications
                ...
                Column(
                    ...
                    Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                        Row(
                            ...
                            Text(
                                text = "Mathematical Theory & Proof Breakdown",
                                style = MaterialTheme.typography.labelLarge,
                                fontWeight = FontWeight.Bold,
                                color = MaterialTheme.colorScheme.primary
                            )
                    ...
                    // Important Identities & Theorems
                    if (topic.importantIdentitiesAndTheorems.isNotEmpty()) {
                        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                            Row(
                                verticalAlignment = Alignment.CenterVertically,
                                horizontalArrangement = Arrangement.spacedBy(6.dp)
                                ...
                                Text(
                                    text = "Core Theorems, Lemmas & Corollaries",
                                    style = MaterialTheme.typography.labelLarge,
                                    fontWeight = FontWeight.Bold,
                                    color = MaterialTheme.colorScheme.tertiary
                                )
                            ...
                            topic.importantIdentitiesAndTheorems.forEach { theorem ->
                                Row(
                    ...
                    if (topic.realWorldApplications.isNotEmpty()) {
                        Column(verticalArrangement = Arrangement.spacedBy(6.dp)) {
                            Row(
                                ...
                                Text(
                                    text = "Real-World & Computational Applications",
                                    style = MaterialTheme.typography.labelLarge,
                                    fontWeight = FontWeight.Bold,
                                    color = MaterialTheme.colorScheme.primary
                                )
            ...
            Surface(
                ...
                modifier = Modifier
                    .fillMaxWidth()
                    .testTag("expand_math_topic_${topic.id}")
            ) {
                Row(
                    ...
                    Text(
                        text = if (isExpanded) "Hide Detailed Theory & Theorems" else "View Theorems, Proofs & Applications",
                        style = MaterialTheme.typography.labelMedium,
                        fontWeight = FontWeight.SemiBold,
                        color = MaterialTheme.colorScheme.primary
                    )
    ...
    Surface(
        ...
        Column(
                ...
                Row(horizontalArrangement = Arrangement.spacedBy(4.dp)) {
                    ...
                    IconButton(
                        onClick = {
                            ...
                            val clip = ClipData.newPlainText("Math Formula", "${formula.title}: ${formula.formulaLatex}")
            ...
            AnimatedVisibility(visible = showCalculator && formula.canCalculate && formula.calculateFn != null) {
                MathFormulaInteractiveCalculator(formula = formula)
            }
        }
    }
}
...
@Composable
fun MathFormulaInteractiveCalculator(
    formula: MathFormula
) {
        ...
        Column(
            ...
            Surface(
                ...
                Row(
                    ...
                    Text(
                        text = if (calculatedResult != null && !calculatedResult.isNaN()) {
                            if (formula.outputUnit.isNotEmpty()) {
                                String.format(Locale.US, "%.4f %s", calculatedResult, formula.outputUnit)
                            } else {
                                String.format(Locale.US, "%.4f", calculatedResult)
                            }
                        } else {
                            "Invalid / Complex"
                        },
